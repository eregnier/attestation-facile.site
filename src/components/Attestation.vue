  ...
  <b-card>
    ...
    <div v-if="!fold">
      <b-form-group label="Prénom">
        <b-input
          placeholder="ex: Jocelyne"
          v-model="form.firstname"
        />
      </b-form-group>
      <b-form-group label="Nom">
        <b-input
          placeholder="ex: Stiche"
          v-model="form.lastname"
        />
      </b-form-group>
      <b-form-group label="Date de naissance">
        <b-input
          placeholder="ex: 10/05/1975"
      ...
      <b-form-group label="Adresse">
        <b-input
          placeholder="ex: 12 rue des fourmis"
          v-model="form.adress"
        />
      </b-form-group>
...
<script>
  ...
  import { BIconReplyAllFill } from 'bootstrap-vue'
  export default {
    components: { BIconReplyAllFill },
    data () {
      return {
        form: {},
        agree: false,
    ...
    created () {
      ...
      this.selectedReason = JSON.parse(localStorage.getItem("reason") || "{}");
      console.log("selected reason", this.selectedReason);
      this.setNow();
      this.setToday();
      this.fold = localStorage.getItem('fold') === '1'
    },
    watch: {
      form: {
        handler: (form) => {
      ...
      setNow () {
        ...
        this.form = {
          ...
          attestationTime: `${d
            ...
            .toString()
            .padStart(2, "0")}h${d.getMinutes().toString().padStart(2, "0")} ${d.getHours() >= 12 ? "pm" : "am"
            }`,
        };
      },
      onAgree () {
